...
const Home = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col text-center mt-32 mx-6  lg:space-x-32">
      ...
      <Link to='/Contact' className="px-6 py-2 rounded-md text-white bg-gradient-to-r from-pink-500 via-red-500 to-orange-500">
        Get in Contact
      </Link>  
    </div>
      <div>
      <div className="flex items-center justify-center  animate-pulse text-xl text-black mt-36 cursor-pointer">
